...
optim_wrapper = dict(
    ...
    type='OptimWrapper')
optimizer = dict(lr=5e-05, momentum=0.9, type='SGD', weight_decay=0.001)
param_scheduler = [
    dict(
...
train_pipeline = [
    ...
    dict(degree=20, flip_prob=0.5, rotate_prob=0.5, type='RandomRotFlip'),
    dict(type='PackSegInputs'),
]
...
work_dir = './work_dirs/umixformer_mit-b0_8xb2-160k_brats2020-adek_extension'
workflow = [
    (
        'train',
        1,
